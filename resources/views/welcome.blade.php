...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="card border border-light-subtle shadow-lg text-center p-5 rounded-0 bg-white" style="max-width: 550px;">
        ...
        <div class="d-grid px-2">
            <a href="{{ route('login') }}" class="btn btn-primary btn-lg rounded-0 py-3 fw-semibold shadow-sm text-uppercase tracking-wider small d-flex align-items-center justify-content-center gap-2">
